...
_GUIDES = {
    ...
    "music": (
        ...
        "<b>Lyria</b> — быстрые клипы и фон, без настроек.\n"
        "<b>Suno V6</b> — полноценные песни с вокалом: открывает экран настроек, где задаются стиль, "
        "текст песни, название, инструментал, пол голоса, точность стиля, креативность, "
        "разнообразие и длительность. Suno всегда отдаёт два варианта.\n\n"
